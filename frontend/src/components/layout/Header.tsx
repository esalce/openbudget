  ...
  return (
    <aside className="w-64 bg-gray-800 text-white flex flex-col">
      <div className="p-4 border-b border-gray-700">
        <h2 className="text-2xl font-bold">OpenBudget</h2>
      </div>
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white py-3 px-4 text-center text-sm text-gray-500 border-t">
      <p>&copy; {new Date().getFullYear()} OpenBudget. An open-source YNAB-style budgeting app.</p>
    </footer>
  );
};
