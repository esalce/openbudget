...
// Using let instead of const so we can modify the array with our service functions
export let mockTransactions: Transaction[] = [
  {
    ...
    payee: 'Landlord',
    categoryId: '1001',
    accountId: 'acc1', // Added accountId
    memo: 'November Rent',
    cleared: true,
  ...
  },
  {
    ...
    categoryId: '2003',
    accountId: 'acc2', // Added accountId
...
export const mockTransactionService = {
  ...
  getTransactionsByAccountId: (accountId: string) => 
    Promise.resolve(mockTransactions.filter(t => t.accountId === accountId)),
  ...
  deleteTransaction: (id: string) => {
    ...
    return Promise.resolve(initialLength > mockTransactions.length);
  },
  
  // Helper to get transactions by category
  getTransactionsByCategory: (categoryId: string) => 
    Promise.resolve(mockTransactions.filter(t => t.categoryId === categoryId)),
};
